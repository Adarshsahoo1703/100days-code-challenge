...
class Solution
{
    ...
    {
        // If the node is a leaf, it satisfies the property.
        ...
        if (node.data == (leftSum + rightSum) && isSumPropertyUtil(node.left) && isSumPropertyUtil(node.right))
            return true;
    ...
    {
        // If the tree is empty, it satisfies the property.
        if (root == null)
            return 1;

        // Check the sum property starting from the root.
